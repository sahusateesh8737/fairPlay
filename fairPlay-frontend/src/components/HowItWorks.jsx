      ...
      <div className="container relative z-10 px-6 mx-auto max-w-5xl">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            From creation to forensic review, FairPlay secures every step of the process with deep React integration.
          </p>
        </motion.div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
          {/* Connecting line for desktop - Scroll Linked */}
          <div className="hidden md:block absolute top-12 left-[10%] right-[10%] h-0.5 bg-border/50 z-0 overflow-hidden rounded-full">
            <motion.div 
          ...
          {steps.map((step, index) => (
            ...
            >
              <motion.div 
                ...
                className="w-24 h-24 rounded-full bg-surface backdrop-blur-md border-4 border-background flex items-center justify-center mb-6 shadow-xl ring-2 ring-border group-hover:ring-primary/50 transition-all duration-300 relative"
              >
                <motion.div
                  animate={{ y: [0, -5, 0] }}
